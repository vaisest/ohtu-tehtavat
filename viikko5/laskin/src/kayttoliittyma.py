...
class Summa:
    def __init__(self, sovellus, io_funktio):
        self.sovellus = sovellus
        self.lue = io_funktio

    def suorita(self):
        self.sovellus.historia = self.sovellus.tulos
        self.sovellus.tulos += self.lue()

    def kumoa(self):
        self.sovellus.tulos = self.sovellus.historia
...
class Kayttoliittyma:
    ...
    def _suorita_komento(self, komento):
        ...
        self._komennot[Komento.KUMOA].viimeisin_komento = komento_olio
